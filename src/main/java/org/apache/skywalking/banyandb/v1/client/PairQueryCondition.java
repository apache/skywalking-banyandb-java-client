...
public abstract class PairQueryCondition<T> extends FieldAndValue<T> {
    ...
    private PairQueryCondition(String fieldName, Banyandb.Condition.BinaryOp op, T value) {
    ...
    public static class LongQueryCondition extends PairQueryCondition<Long> {
        private LongQueryCondition(String fieldName, Banyandb.Condition.BinaryOp op, Long value) {
        ...
        public static PairQueryCondition<Long> eq(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<Long> ne(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<Long> gt(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_GT, val);
        }
        ...
        public static PairQueryCondition<Long> ge(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_GE, val);
        }
        ...
        public static PairQueryCondition<Long> lt(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_LT, val);
        }
        ...
        public static PairQueryCondition<Long> le(String fieldName, Long val) {
            return new LongQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_LE, val);
        }
    }
    ...
    public static class StringQueryCondition extends PairQueryCondition<String> {
        private StringQueryCondition(String fieldName, Banyandb.Condition.BinaryOp op, String value) {
            super(fieldName, op, value);
        }
        ...
        public static PairQueryCondition<String> eq(String fieldName, String val) {
            return new StringQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<String> ne(String fieldName, String val) {
            return new StringQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NE, val);
        }
    }
    ...
    public static class StringArrayQueryCondition extends PairQueryCondition<List<String>> {
        private StringArrayQueryCondition(String fieldName, Banyandb.Condition.BinaryOp op, List<String> value) {
            super(fieldName, op, value);
        }
        ...
        public static PairQueryCondition<List<String>> eq(String fieldName, List<String> val) {
            return new StringArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<List<String>> ne(String fieldName, List<String> val) {
            return new StringArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<List<String>> having(String fieldName, List<String> val) {
            return new StringArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_HAVING, val);
        }
        ...
        public static PairQueryCondition<List<String>> notHaving(String fieldName, List<String> val) {
            return new StringArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NOT_HAVING, val);
        }
    }
    ...
    public static class LongArrayQueryCondition extends PairQueryCondition<List<Long>> {
        private LongArrayQueryCondition(String fieldName, Banyandb.Condition.BinaryOp op, List<Long> value) {
            super(fieldName, op, value);
        }
        ...
        public static PairQueryCondition<List<Long>> eq(String fieldName, List<Long> val) {
            return new LongArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<List<Long>> ne(String fieldName, List<Long> val) {
            return new LongArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<List<Long>> having(String fieldName, List<Long> val) {
            return new LongArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_HAVING, val);
        }
        ...
        public static PairQueryCondition<List<Long>> notHaving(String fieldName, List<Long> val) {
            return new LongArrayQueryCondition(fieldName, Banyandb.Condition.BinaryOp.BINARY_OP_NOT_HAVING, val);
        }
    }
}
