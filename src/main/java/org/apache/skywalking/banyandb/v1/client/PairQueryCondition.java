...
public abstract class PairQueryCondition<T> extends TagAndValue<T> {
    ...
    private PairQueryCondition(String tagFamilyName, String tagName, BanyandbModel.Condition.BinaryOp op, T value) {
    ...
    public static class LongQueryCondition extends PairQueryCondition<Long> {
        private LongQueryCondition(String tagFamilyName, String tagName, BanyandbModel.Condition.BinaryOp op, Long value) {
        ...
        public static PairQueryCondition<Long> eq(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<Long> ne(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<Long> gt(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_GT, val);
        }
        ...
        public static PairQueryCondition<Long> ge(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_GE, val);
        }
        ...
        public static PairQueryCondition<Long> lt(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_LT, val);
        }
        ...
        public static PairQueryCondition<Long> le(String tagFamilyName, String tagName, Long val) {
            return new LongQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_LE, val);
        }
    }
    ...
    public static class StringQueryCondition extends PairQueryCondition<String> {
        private StringQueryCondition(String tagFamilyName, String tagName, BanyandbModel.Condition.BinaryOp op, String value) {
            super(tagFamilyName, tagName, op, value);
        }
        ...
        public static PairQueryCondition<String> eq(String tagFamilyName, String tagName, String val) {
            return new StringQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<String> ne(String tagFamilyName, String tagName, String val) {
            return new StringQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NE, val);
        }
    }
    ...
    public static class StringArrayQueryCondition extends PairQueryCondition<List<String>> {
        private StringArrayQueryCondition(String tagFamilyName, String tagName, BanyandbModel.Condition.BinaryOp op, List<String> value) {
            super(tagFamilyName, tagName, op, value);
        }
        ...
        public static PairQueryCondition<List<String>> eq(String tagFamilyName, String tagName, List<String> val) {
            return new StringArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<List<String>> ne(String tagFamilyName, String tagName, List<String> val) {
            return new StringArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<List<String>> having(String tagFamilyName, String tagName, List<String> val) {
            return new StringArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_HAVING, val);
        }
        ...
        public static PairQueryCondition<List<String>> notHaving(String tagFamilyName, String tagName, List<String> val) {
            return new StringArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NOT_HAVING, val);
        }
    }
    ...
    public static class LongArrayQueryCondition extends PairQueryCondition<List<Long>> {
        private LongArrayQueryCondition(String tagFamilyName, String tagName, BanyandbModel.Condition.BinaryOp op, List<Long> value) {
            super(tagFamilyName, tagName, op, value);
        }
        ...
        public static PairQueryCondition<List<Long>> eq(String tagFamilyName, String tagName, List<Long> val) {
            return new LongArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_EQ, val);
        }
        ...
        public static PairQueryCondition<List<Long>> ne(String tagFamilyName, String tagName, List<Long> val) {
            return new LongArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NE, val);
        }
        ...
        public static PairQueryCondition<List<Long>> having(String tagFamilyName, String tagName, List<Long> val) {
            return new LongArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_HAVING, val);
        }
        ...
        public static PairQueryCondition<List<Long>> notHaving(String tagFamilyName, String tagName, List<Long> val) {
            return new LongArrayQueryCondition(tagFamilyName, tagName, BanyandbModel.Condition.BinaryOp.BINARY_OP_NOT_HAVING, val);
        }
    }
}
